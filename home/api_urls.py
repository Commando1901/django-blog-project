...
from .api_views import blog_create_api, blog_delete_api, blog_list_api, blog_detail_api, blog_update_api
...
urlpatterns = [
    ...
    path('blogs/<int:id>/delete/', blog_delete_api, name='blog-delete-api'),
]